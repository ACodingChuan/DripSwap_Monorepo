...
contract FixCCIP_vDAI is DeployBase {
    ...
    function run() external {
        console2.log("=== Fix CCIP Configuration for vDAI ===");
    ...
    function _loadTokenConfig() internal view returns (TokenConfig memory cfg) {
        if (block.chainid == 534351) {
            cfg.localToken = 0x0C156E2F45a812ad743760A88d73fB22879BC299;
            cfg.localPool = 0x9BD15faC563c470E64B6D4917E2f79d1960a3cA0;
            cfg.remoteToken = 0x0C156E2F45a812ad743760A88d73fB22879BC299;
            cfg.remotePool = 0xF774dC8f6D0c92e6cB2E0260dCc720c5E1571d31;
            cfg.bridge = 0xBE2CcDA786BF69B0AE4251E6b34dF212CEF4F645;
        } else {
            cfg.localToken = 0x0C156E2F45a812ad743760A88d73fB22879BC299;
            cfg.localPool = 0xF774dC8f6D0c92e6cB2E0260dCc720c5E1571d31;
            cfg.remoteToken = 0x0C156E2F45a812ad743760A88d73fB22879BC299;
            cfg.remotePool = 0x9BD15faC563c470E64B6D4917E2f79d1960a3cA0;
