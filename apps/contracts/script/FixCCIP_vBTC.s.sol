...
contract FixCCIP_vBTC is DeployBase {
    ...
    function run() external {
        console2.log("=== Fix CCIP Configuration for vBTC ===");
    ...
    function _loadTokenConfig() internal view returns (TokenConfig memory cfg) {
        if (block.chainid == 534351) {
            cfg.localToken = 0xAeA8C2F08b10Fe1853300dF4332E462b449e19D6;
            cfg.localPool = 0xf508fF4a3BccC4284E817A0c7d43604c2aabfC70;
            cfg.remoteToken = 0xAeA8C2F08b10Fe1853300dF4332E462b449e19D6;
            cfg.remotePool = 0x0Ee1e426b2DCE06a34DF8f23463e2559F75ba880;
            cfg.bridge = 0xBE2CcDA786BF69B0AE4251E6b34dF212CEF4F645;
        } else {
            cfg.localToken = 0xAeA8C2F08b10Fe1853300dF4332E462b449e19D6;
            cfg.localPool = 0x0Ee1e426b2DCE06a34DF8f23463e2559F75ba880;
            cfg.remoteToken = 0xAeA8C2F08b10Fe1853300dF4332E462b449e19D6;
            cfg.remotePool = 0xf508fF4a3BccC4284E817A0c7d43604c2aabfC70;
