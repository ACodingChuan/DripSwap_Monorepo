...
contract FixCCIP_vSCR is DeployBase {
    ...
    function run() external {
        console2.log("=== Fix CCIP Configuration for vSCR ===");
    ...
    function _loadTokenConfig() internal view returns (TokenConfig memory cfg) {
        if (block.chainid == 534351) {
            cfg.localToken = 0x4911Fb3923F6DA0cd4920F914991B0A742d88Bfd;
            cfg.localPool = 0x727db78a67D46871a0d9EF2eA33be5e1e53F59A0;
            cfg.remoteToken = 0x4911Fb3923F6DA0cd4920F914991B0A742d88Bfd;
            cfg.remotePool = 0xf985F69e6bE82F3EDeF82A2FE256b0eF4d114bd0;
            cfg.bridge = 0xBE2CcDA786BF69B0AE4251E6b34dF212CEF4F645;
        } else {
            cfg.localToken = 0x4911Fb3923F6DA0cd4920F914991B0A742d88Bfd;
            cfg.localPool = 0xf985F69e6bE82F3EDeF82A2FE256b0eF4d114bd0;
            cfg.remoteToken = 0x4911Fb3923F6DA0cd4920F914991B0A742d88Bfd;
            cfg.remotePool = 0x727db78a67D46871a0d9EF2eA33be5e1e53F59A0;
