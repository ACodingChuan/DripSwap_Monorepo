...
contract FixCCIP_vLINK is DeployBase {
    ...
    function run() external {
        console2.log("=== Fix CCIP Configuration for vLINK ===");
    ...
    function _loadTokenConfig() internal view returns (TokenConfig memory cfg) {
        if (block.chainid == 534351) {
            cfg.localToken = 0x1A95d5d1930b807B62B20f3cA6b2451Ffc75B454;
            cfg.localPool = 0xc780c0Df0dF908fc118296Ac62798E321A7BA64e;
            cfg.remoteToken = 0x1A95d5d1930b807B62B20f3cA6b2451Ffc75B454;
            cfg.remotePool = 0x4BE437a25237C511d316a8c8Bc594b422abAd2d1;
            cfg.bridge = 0xBE2CcDA786BF69B0AE4251E6b34dF212CEF4F645;
        } else {
            cfg.localToken = 0x1A95d5d1930b807B62B20f3cA6b2451Ffc75B454;
            cfg.localPool = 0x4BE437a25237C511d316a8c8Bc594b422abAd2d1;
            cfg.remoteToken = 0x1A95d5d1930b807B62B20f3cA6b2451Ffc75B454;
            cfg.remotePool = 0xc780c0Df0dF908fc118296Ac62798E321A7BA64e;
