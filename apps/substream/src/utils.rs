...
use crate::{constants, storage, Erc20Token, StorageChange};
use std::ops::{Add, Mul};
...
// V2: 使用常量模块中的白名单
use constants::WHITELIST_TOKENS;

// V2: Factory 地址（两链相同 - 确定性部署）
pub const UNISWAP_V2_FACTORY: [u8; 20] = hex!("6c9258026a9272368e49bbb7d0a78c17bbe284bf");
