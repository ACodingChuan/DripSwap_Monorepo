...
// V2: fee_growth_global 相关函数在 V2 中不使用(V3 特有)
...
// --------------------
// V2: Position 相关函数在 V2 中不使用（V2 使用 LP Token，V3 使用 Position NFT）
...
// --------------------
// V2: PositionSnapshot 相关函数在 V2 中不使用
