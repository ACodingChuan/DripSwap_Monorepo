    ...
    pub mod functions {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct AllowPayInLink {}
        impl AllowPayInLink {
            const METHOD_ID: [u8; 4] = [81u8, 213u8, 119u8, 245u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for AllowPayInLink {
            const NAME: &'static str = "allowPayInLink";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for AllowPayInLink {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct AllowPayInNative {}
        impl AllowPayInNative {
            const METHOD_ID: [u8; 4] = [68u8, 116u8, 64u8, 63u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for AllowPayInNative {
            const NAME: &'static str = "allowPayInNative";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for AllowPayInNative {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct IsTokenSupported {
            pub token: Vec<u8>,
        }
        impl IsTokenSupported {
            const METHOD_ID: [u8; 4] = [117u8, 21u8, 27u8, 99u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for IsTokenSupported {
            const NAME: &'static str = "isTokenSupported";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for IsTokenSupported {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        ...
        impl MaxAmount {
            const METHOD_ID: [u8; 4] = [95u8, 72u8, 243u8, 147u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for MaxAmount {
            const NAME: &'static str = "maxAmount";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl MinAmount {
            const METHOD_ID: [u8; 4] = [155u8, 44u8, 181u8, 216u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for MinAmount {
            const NAME: &'static str = "minAmount";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct QuoteFee {
            pub token: Vec<u8>,
            pub dst_selector: substreams::scalar::BigInt,
            pub receiver: Vec<u8>,
            pub amount: substreams::scalar::BigInt,
            pub pay_in_link: bool,
        }
        impl QuoteFee {
            const METHOD_ID: [u8; 4] = [167u8, 15u8, 58u8, 227u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
                    ...
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.dst_selector.clone().to_bytes_be() {
                        ...
                        ethabi::Token::Bool(self.pay_in_link.clone()),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
        ...
        impl substreams_ethereum::Function for QuoteFee {
            const NAME: &'static str = "quoteFee";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct RegisterTokenPool {
            pub token: Vec<u8>,
            pub pool: Vec<u8>,
        }
        impl RegisterTokenPool {
            const METHOD_ID: [u8; 4] = [17u8, 98u8, 127u8, 69u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for RegisterTokenPool {
            const NAME: &'static str = "registerTokenPool";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct RemoveTokenPool {
            pub token: Vec<u8>,
        }
        impl RemoveTokenPool {
            const METHOD_ID: [u8; 4] = [126u8, 46u8, 204u8, 203u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for RemoveTokenPool {
            const NAME: &'static str = "removeTokenPool";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl SendToken {
            const METHOD_ID: [u8; 4] = [125u8, 9u8, 168u8, 214u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
                ...
                let mut values = ethabi::decode(
                        &[
                            ...
                            ethabi::ParamType::Tuple(
                                vec![
                                    ethabi::ParamType::Tuple(vec![ethabi::ParamType::Array(Box::new(ethabi::ParamType::Tuple(vec![ethabi::ParamType::Address,
                                    ethabi::ParamType::Uint(256usize)]))),
                                    ethabi::ParamType::Uint(256usize),
                                    ethabi::ParamType::Uint(256usize)]),
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Tuple(
                            vec![
                                ethabi::Token::Tuple(vec![{ let v = self.permit_input.0.0
                                .iter().map(| inner |
                                ...
                                .permit_input.0.1.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .permit_input.0.2.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),)]), ethabi::Token::Bytes(self.permit_input.1
                                .clone())
                            ],
                        ),
                    ],
        ...
        impl substreams_ethereum::Function for SendToken {
            const NAME: &'static str = "sendToken";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for SendToken {
            fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
                Self::output(data)
            }
        }
        ...
        impl ServiceFee {
            const METHOD_ID: [u8; 4] = [138u8, 189u8, 245u8, 170u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for ServiceFee {
            const NAME: &'static str = "serviceFee";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct SetLimits {
            pub min: substreams::scalar::BigInt,
            pub max: substreams::scalar::BigInt,
        }
        impl SetLimits {
            const METHOD_ID: [u8; 4] = [196u8, 89u8, 13u8, 63u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.min.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for SetLimits {
            const NAME: &'static str = "setLimits";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetPayMethod {
            pub allow_native: bool,
            pub allow_link: bool,
        }
        impl SetPayMethod {
            const METHOD_ID: [u8; 4] = [1u8, 128u8, 119u8, 196u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Bool(self.allow_native.clone()),
                        ethabi::Token::Bool(self.allow_link.clone()),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
        ...
        impl substreams_ethereum::Function for SetPayMethod {
            const NAME: &'static str = "setPayMethod";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct SetServiceFee {
            ...
            pub new_collector: Vec<u8>,
        }
        impl SetServiceFee {
            const METHOD_ID: [u8; 4] = [141u8, 19u8, 190u8, 146u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.new_collector),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        impl substreams_ethereum::Function for SetServiceFee {
            const NAME: &'static str = "setServiceFee";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl TokenPools {
            const METHOD_ID: [u8; 4] = [195u8, 210u8, 195u8, 193u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for TokenPools {
            const NAME: &'static str = "tokenPools";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for TokenPools {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
    ...
    pub mod events {
        ...
        pub struct LimitsUpdated {
            ...
            pub max_amount: substreams::scalar::BigInt,
        }
        impl LimitsUpdated {
        ...
        impl substreams_ethereum::Event for LimitsUpdated {
            const NAME: &'static str = "LimitsUpdated";
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct PayMethodUpdated {
            pub native_allowed: bool,
            pub link_allowed: bool,
        }
        impl PayMethodUpdated {
            const TOPIC_ID: [u8; 32] = [
                68u8,
                151u8,
                195u8,
        ...
        impl substreams_ethereum::Event for PayMethodUpdated {
            const NAME: &'static str = "PayMethodUpdated";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for ServiceFeeUpdated {
            const NAME: &'static str = "ServiceFeeUpdated";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct TokenPoolRegistered {
            pub token: Vec<u8>,
            pub pool: Vec<u8>,
        }
        impl TokenPoolRegistered {
            const TOPIC_ID: [u8; 32] = [
                105u8,
                159u8,
                83u8,
        ...
        impl substreams_ethereum::Event for TokenPoolRegistered {
            const NAME: &'static str = "TokenPoolRegistered";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct TokenPoolRemoved {
            pub token: Vec<u8>,
        }
        impl TokenPoolRemoved {
            const TOPIC_ID: [u8; 32] = [
                19u8,
                169u8,
                184u8,
        ...
        impl substreams_ethereum::Event for TokenPoolRemoved {
            const NAME: &'static str = "TokenPoolRemoved";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct TransferInitiated {
            ...
            pub amount: substreams::scalar::BigInt,
            pub pay_in_link: bool,
            pub ccip_fee: substreams::scalar::BigInt,
            pub service_fee_paid: substreams::scalar::BigInt,
        }
        ...
        impl substreams_ethereum::Event for TransferInitiated {
            const NAME: &'static str = "TransferInitiated";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
