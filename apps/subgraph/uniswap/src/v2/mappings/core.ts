...
export function handleTransfer(event: Transfer): void {
  ...
  log.debug('handleTransfer pair {} tx {} from {} to {} value {}', [
    pair.id,
    transactionHash,
...
export function handleSync(event: Sync): void {
  ...
  log.debug('handleSync pair {} block {} reserve0 {} reserve1 {}', [
    pair.id,
...
export function handleMint(event: Mint): void {
  ...
  log.debug('handleMint pair {} tx {} block {} amount0 {} amount1 {} sender {}', [
    pair.id,
...
export function handleSwap(event: Swap): void {
  ...
  log.debug('handleSwap pair {} tx {} sender {} amount0In {} amount1In {} amount0Out {} amount1Out {}', [
    pair.id,
    event.transaction.hash.toHexString(),
    event.params.sender.toHexString(),
    amount0In.toString(),
