...
import { ALMOST_ZERO_BD, ONE_BI, ZERO_BD, ZERO_BI } from '../../common/constants'
...
export function handleSync(event: Sync): void {
  ...
  log.debug('v2-tokens handleSync pair {} block {} reserve0 {} reserve1 {}', [
    pair.id,
  ...
  if (!bundle) {
    ...
    bundle.oracleRoundId = ZERO_BI
  }
  let oraclePrice = getEthPriceInUSD()
  bundle.ethPrice = oraclePrice.price
  bundle.oracleRoundId = oraclePrice.roundId
  bundle.save()
...
export function handleSwap(event: Swap): void {
  ...
  log.debug('v2-tokens handleSwap pair {} tx {} amount0In {} amount1In {} amount0Out {} amount1Out {}', [
    pair.id,
