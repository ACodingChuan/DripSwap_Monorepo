...
export const STABLE1_ADDRESS = Address.fromHexString('{{ v2.stable1 }}')
export const STABLE2_ADDRESS = Address.fromHexString('{{ v2.stable2 }}')
...
export const ORACLE_ADDRESS = '{{ v2.oracleAddress }}'
